...
person_pb.PHONE = PHONE
local PHONE_PHONE_TYPE = protobuf.EnumDescriptor();
person_pb.PHONE_PHONE_TYPE = PHONE_PHONE_TYPE
...
PHONE_TYPE_FIELD.enum_type = PHONE.PHONE_TYPE
...
person_pb.Phone = protobuf.Message(PHONE)

person_pb.Person.RegisterExtension(PHONE_PHONES_FIELD)
return person_pb
